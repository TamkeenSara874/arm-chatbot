...
async def decompose_query(
    ...
    """
    raw = await client.complete(prompt, system=system, temperature=0.0, max_tokens=512)
    ...
    try:
        raw2 = await client.complete(retry_prompt, system=system, temperature=0.0, max_tokens=512)
